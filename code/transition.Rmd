...
plot(trans$time, trans$prop.veg, pch = 22, 
          ...
          xlim = c(-100, 3750), ylim = c(-0.1, 1.1), yaxt = "n", xaxt = "n")
box(lwd = 2)
...
axis(side = 1, lwd.ticks = 2, cex.axis = 1.25,
    at = c(0, 500, 1000, 1500, 2000, 2500, 3000, 3500), labels = T)

axis(side = 3, lwd.ticks = 2, cex.axis = 1.25,
    at = c(0, 500, 1000, 1500, 2000, 2500, 3000, 3500), labels = F)
...
curve(coef(fit)[[2]] + (coef(fit)[[1]] - coef(fit)[[2]]) / 
      ...
      from = 0, to = 3600, add = TRUE, lty = 2, lwd = 2.5, col = "red") 
...
plot(trans$time, log10(trans$veg.ab), pch = 22, 
          bg = "red", cex = 1.25, col = "black", lwd = 1, cex.axis = 1.25, xlab = NA, ylab = NA,
          xlim = c(-100, 3750), ylim = c(1, 8), yaxt = "n", xaxt = "n")
points(trans$time, log10(trans$spo.ab), pch = 22, lwd = 1, bg = "blue", cex = 1.25)
