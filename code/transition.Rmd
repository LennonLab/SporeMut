...
plot(trans$time, trans$prop.veg, pch = 22, 
          ...
          xlim = c(-100, 1100), ylim = c(-0.1, 1.1), yaxt = "n", xaxt = "n")
box(lwd = 2)
...
axis(side = 1, lwd.ticks = 2, cex.axis = 1.25,
    at = c(0, 200, 400, 600, 800, 1000), labels = T)

axis(side = 3, lwd.ticks = 2, cex.axis = 1.25,
    at = c(0, 200, 400, 600, 800, 1000), labels = F)
...
curve(coef(fit)[[2]] + (coef(fit)[[1]] - coef(fit)[[2]]) / 
      ...
      from = 0, to = 1000, add = TRUE, lty = 2, lwd = 2.5, col = "red") 
...
plot(trans$time, log10(trans$spo.ab), pch = 22, 
          ...
          xlim = c(-100, 1100), ylim = c(1, 8), yaxt = "n", xaxt = "n")
points(trans$time, log10(trans$veg.ab), pch = 22, lwd = 1, bg = "red", cex = 1.25)

box(lwd = 2)

axis(side = 2, lwd.ticks = 2, cex.axis = 2, las = 1,
...
axis(side = 1, lwd.ticks = 2, cex.axis = 2,
