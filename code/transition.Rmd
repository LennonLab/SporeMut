...
plot(trans$time, trans$prop.veg, pch = 22, 
          ...
          xlim = c(-100, 1600), ylim = c(-0.1, 1.1), yaxt = "n", xaxt = "n")
box(lwd = 2)
...
axis(side = 1, lwd.ticks = 2, cex.axis = 1.25,
    at = c(0, 500, 1000, 1500), labels = T)

axis(side = 3, lwd.ticks = 2, cex.axis = 1.25,
    at = c(0, 500, 1000, 1500), labels = F)
...
curve(coef(fit)[[2]] + (coef(fit)[[1]] - coef(fit)[[2]]) / 
      ...
      from = 0, to = 1500, add = TRUE, lty = 2, lwd = 2.5, col = "red") 
...
plot(trans$time, log10(trans$spo.ab), pch = 22, 
          ...
          xlim = c(-100, 1600), ylim = c(1, 8), yaxt = "n", xaxt = "n")
