...
end.data <- read.table("data/spore.transition.ltde.txt", header = TRUE)
head(end.data)
...
```{r}
png(filename="/Users/lennonj/GitHub/SporeMut/output/pop.densities.D.BayesV.png",
...
# Show Plot
img <- readPNG("/Users/lennonj/GitHub/SporeMut/output/pop.densities.D.BayesV.png")
grid.raster(img)
```