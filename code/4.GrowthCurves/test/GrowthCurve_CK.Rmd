...
```{r}
treats_param$clone <- as.factor(treats_param$clone)
treats_param$clone <- ordered(treats_param$clone, levels = c('ancestor', 'm4','m13','m17','m19','m21','m23','m26','m41','m54','m79'))
contrasts(treats_param$clone) <- contr.treatment(11, base = 1)  # Treat Control as the reference level
custom_contrasts_clone <- as.matrix(contrasts(treats_param$clone))
