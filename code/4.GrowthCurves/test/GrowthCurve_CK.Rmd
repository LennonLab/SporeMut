...
rr4 <- rope_range(m2L)
result1LR <- describe_posterior(m2L, centrality = c("median", "mean"),
                          rope_ci = 0.95, 
                          ci = 0.95,
                          ci_method = "HDI", 
                    test = c("equivalence_test", "p_direction", "p_significance"),
...
pars <- c("b_clonem26", "b_clonem23", "b_clonem54", "b_clonem41", "b_clonem21",
  "b_clonem19",  "b_clonem17", "b_clonem79", "b_clonem13",  "b_clonem4")
...
pars_random <- c("r_clone[m26,Intercept]", "r_clone[m23,Intercept]", "r_clone[m54,Intercept]", "r_clone[m41,Intercept]", "r_clone[m21,Intercept]", 
                "r_clone[m19,Intercept]",  "r_clone[m17,Intercept]",  "r_clone[m79,Intercept]",  "r_clone[m13,Intercept]", "r_clone[m4,Intercept]")
pars_fixed  <- c("b_mutation2","b_mutation3","b_mutation4" )
